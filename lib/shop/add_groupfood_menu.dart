...
class AddGroupFoodMenu extends StatefulWidget {
  ...
  const AddGroupFoodMenu({Key key, this.userModel}) : super(key: key);
  @override
  ...
  Future<Null> uploadGroupFoodAndInsertData() async {
    ...
    try {
      ...
      await Dio().post(urlUpload, data: formData).then((value) async {
        String urlPathImage = '/smlao/GroupFood/$nameFile';
        ...
        String urlInsertData =
            '${MyConstant().domain}/smlao/addGroupFood.php?isAdd=true&idShop=$idShop&NameGroup=$nameGroup&PathImage=$urlPathImage';
