...
class _AddInfoShopState extends State<AddInfoShop> {
  ...
  Future<Null> uploadImage() async {
    ...
    String url = '${MyConstant().domain}/smlao/saveShop.php';
  ...
  Future<Null> editUserShop() async {
    ...
    String url =
        '${MyConstant().domain}/smlao/editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlImage&Lat=$lat&Lng=$lng';
