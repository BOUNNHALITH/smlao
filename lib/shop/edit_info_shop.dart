...
class _EditInfoShopState extends State<EditInfoShop> {
  ...
  Future<Null> editThread() async {
    ...
    String urlUpload = '${MyConstant().domain}/smlao/saveShop.php';
    await Dio().post(urlUpload, data: formData).then((value) async {
      urlPicture = '/smlao/Shop/$nameFile';
      String id = userModel.id;
      String url =
          '${MyConstant().domain}/smlao/editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlPicture&Lat=$lat&Lng=$lng';
