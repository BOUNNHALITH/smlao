...
import 'package:smlao/shop/add_groupfood_menu.dart';
import 'package:smlao/shop/edit_groupfood_menu.dart';
// import 'package:smlao/shop/edit_food_menu.dart';
// import 'package:smlao/shop/edit_groupfood_menu.dart';
...
class _ListGroupFoodMenuState extends State<ListGroupFoodMenu> {
  ...
  void routeToAddInfo() {
    Widget widget = groupFoodModel.nameGroup.isEmpty
        ? AddGroupFoodMenu()
        : EditGoupFoodMenu();
            ...
            children: <Widget>[
              ElevatedButton(
                onPressed: () async {
                  ...
                  String url =
                      '${MyConstant().domain}/smlao/deleteGroupFoodWhereId.php?isAdd=true&id=${groupFoodModel.id}';
