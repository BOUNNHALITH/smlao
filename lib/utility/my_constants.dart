...
class MyConstants {
  ...
  // static String domain = 'http://192.168.100.43';

  // Route
  static String routeAuthen = '/home';
  static String routeCreateAccount = '/createAccount';
  static String routeBuyerService = '/Shop';
  static String routeSalerService = '/User';
  static String routeRiderService = '/Rider';
  static String routeAddProduct = '/Admin';
