...
class SQLiteHelper {
  final String nameDatabase = 'smlao.db';
  ...
  Future<Null> initDatabase() async {
    await openDatabase(join(await getDatabasesPath(), nameDatabase),
        onCreate: (db, version) => db.execute(
            'CREATE TABLE $tableDatabase ($idColumn INTEGER PRIMARY KEY, $idShopColumn TEXT, $idUser TEXT ,$nameShop TEXT, $idFood TEXT, $nameFood TEXT, $price TEXT, $amount TEXT, $detail TEXT, $sum TEXT, $distance TEXT, $transport TEXT)'),
        version: version);
  }
